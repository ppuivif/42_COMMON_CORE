...
/*   Updated: 2024/02/23 17:28:48 by ppuivif          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_img_0(t_list_image *t_list)
{
	...
	if (fd >= 0)
		...
		free_t_list(t_list, "Error\nImage img_0 didn't could be created\n");
	close(fd);
}
...
void	create_img_1(t_list_image *t_list)
{
	...
	if (fd >= 0)
		...
		free_t_list(t_list, "Error\nImage img_1 didn't could be created\n");
	close(fd);
}
...
void	create_img_2(t_list_image *t_list)
{
	...
	if (fd >= 0)
		...
		free_t_list(t_list, "Error\nImage img_2 didn't could be created\n");
	close(fd);
}
...
void	create_img_c(t_list_image *t_list)
{
	...
	if (fd >= 0)
		...
		free_t_list(t_list, "Error\nImage img_c didn't could be created\n");
	close(fd);
}
...
void	create_img_e(t_list_image *t_list)
{
	...
	if (fd >= 0)
		...
		free_t_list(t_list, "Error\nImage img_e didn't could be created\n");
	close(fd);
}
