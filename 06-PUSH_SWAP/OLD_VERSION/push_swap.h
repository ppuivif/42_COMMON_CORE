...
int		search_best_sort_next_position_ab(t_list **src, t_list **dest, int next_position);
int		search_best_sort_next_position_ba(t_list **src, t_list **dest, int next_position);
